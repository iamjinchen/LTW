...
def train_main(gpu):
    ...
    for epoch in range(epochs):
        ...
        train_sampler = torch.utils.data.distributed.DistributedSampler(train_dataset,
                                                                    num_replicas=world_size,
                                                                    rank=rank)
        train_dataloader = data.DataLoader(train_dataset, batch_size=batch_size, shuffle=False, num_workers=8,worker_init_fn=worker_init_fn,sampler=train_sampler)#shuffle=tue
