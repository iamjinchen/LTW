...
def train(model,optimizer,fnet,optimizer_fnet,train_dataloader,meta_dataloader,criterion_oc,epoch,epoch_size,device):
    ...
    criterion_norm = torch.nn.BCELoss()
...
def main():
    ...
    for epoch in range(epochs):
        ...
        train_dataloader = data.DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=8,worker_init_fn=worker_init_fn,pin_memory=)
