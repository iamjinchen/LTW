...
def train(model,optimizer,fnet,optimizer_fnet,train_dataloader,meta_dataloader,criterion_oc,epoch,epoch_size,device, accelerator):
    '''
    ...
    for i, datas in enumerate(train_dataloader):
        ...
        images, target = accelerator.prepare(images, targets)
...
def main():
    ...
    fnet, optimizer_fnet,scheduler_fnet = fnet_accelerator.prepare(model, optimizer_fnet,scheduler)
    model.train()
    ...
    for epoch in range(epochs):
        ...
        train(model,optimizer,fnet,optimizer_fnet,train_dataloader,None,criterion_oc,epoch,epoch_size,device,accelerator)
