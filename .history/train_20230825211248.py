...
def main():
    ...
    cele_test_dataset = CeleDF(train = False, frame_nums=frame_nums, transform=_preproc,data_root = celebdf_path,original_path=ffpp_original_path,fake_path=ffpp_fake_path)
