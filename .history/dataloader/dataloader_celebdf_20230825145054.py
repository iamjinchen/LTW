...
class CeleDF(data.Dataset):
    ...
    def __init__(self, train=True, frame_nums=5,
                 transform=None, target_transform=None,data_root = '/media/sdc/datasets/celedf/',Deepfakes_path = f'{self.data_root}/Celeb-synthesis-mtcnn/*'
        original_path = f'{self.data_root}/Celeb-real-mtcnn/*'
        youtube_path = f'{self.data_root}/YouTube-real-mtcnn/*'
        split_path = f'{self.data_root}/List_of_testing_videos.txt' dataset_name='CELEDF'):
        self.train = train
