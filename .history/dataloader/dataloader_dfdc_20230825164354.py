...
class DFDCDetection(data.Dataset):
    def __init__(self, root, train=True, frame_nums=5, 
                transform=None, target_transform=None, dataset_name='DFDC',data_root = '/media/sdc/datasets/celedf/',Deepfakes_path ='/Celeb-synthesis-mtcnn/*',
...
if __name__ == '__main__':
    ...
    test_dataset = DFDCDetection(train=False, frame_nums=12, transform=trans,data_root=dfdc_path,split_path=dfdc_data_list)
