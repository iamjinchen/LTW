...
if __name__ == '__main__':
    ...
    # train_dataset = CeleDF(train=True, frame_nums=3, transform=trans, data_root=celebdf_path, split_path = split_path )
    ...
    test_dataset = CeleDF(train=False, frame_nums=3, transform=trans, data_root=celebdf_path, split_path = split_path)
